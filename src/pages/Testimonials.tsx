...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      role: 'Entrepreneur',
      comment: 'Installation de caméras impeccable. Le système fonctionne parfaitement et je peux surveiller mon entreprise à distance. ??quipe technique très compétente.',
      rating: 5,
